  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'مرحباً! 🎱 أنا مدربك الشخصي للبلياردو. اسألني عن أي استراتيجية أو نصيحة!',
    },
  ]);
    ...
    try {
      ...
      setMessages(prev => [
        ...prev,
        {
          id: (Date.now() + 1).toString(),
          role: 'assistant',
          content: 'عذراً، لم أتمكن من الرد الآن. حاول مرة أخرى.',
        },
      ]);
    } finally {
      setIsLoading(false);
          ...
          >
            ...
            <div className="bg-gradient-to-r from-gold/20 to-amber-500/20 p-4 flex items-center justify-between border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-foreground">مدرب البلياردو</h3>
                  <p className="text-xs text-muted-foreground">مساعد AI</p>
                </div>
              </div>
              <Button
                variant="ghost"
